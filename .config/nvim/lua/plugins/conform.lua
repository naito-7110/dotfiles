    ...
    formatters = {
      ...
      eslint_d = {
        condition = function(_, ctx)
          ...
          return vim.fs.find({ ".eslintrc", ".eslintrc.json", ".eslintrc.js", ".eslintrc.cjs", "eslint.config.js", "eslint.config.mjs" },
      ...
      prettierd = {
        condition = function(_, ctx)
          ...
          if vim.fs.find({ ".oxfmtrc.json", "biome.json", ".eslintrc", ".eslintrc.json", "eslint.config.js" }, { path = ctx.filename, upward = true })[1] then
            return false
          end
          return vim.fs.find({ ".prettierrc", ".prettierrc.json", ".prettierrc.yml", ".prettierrc.yaml", "prettier.config.js", "prettier.config.cjs" },
            { path = ctx.filename, upward = true })[1] ~= nil
        end,
      },
      prettier = {
